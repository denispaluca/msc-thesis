...
AlgoFuzz leverages greybox fuzzing techniques to generate inputs that maximize not only code coverage but also the discovered state space of the smart contract.

The main goal of this project is the development of AlgoFuzz, which will serve as a foundation for future work in the field of Algorand smart contract fuzzing.
